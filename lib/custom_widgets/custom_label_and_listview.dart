                ...
                GestureDetector(
                    onTap: () {
                      Get.to(ViewAllScreen(
                          label: label, channelList: channelList));
                    },
                    child: CustomText(
                        text: 'view_all'.tr, color: greyColor, fontSize: 12.sp))
              ],
            ),
          ),
          SizedBox(
                            ...
                            Positioned(
                              ...
                              child: Obx(
                                () => GestureDetector(
                                  ...
                                  child: Icon(
                                    Icons.favorite,
                                    color: channelController.selectedChannelList
                                            .any((element) =>
                                                element.name ==
